...
namespace ArgesDataCollectionWithWpf.CodeFirst
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string ConnectionString2 = "Host=127.0.0.1;Port=5432;User Id=postgres;Password=123456@Qq;Database=zd_data_from_mssql;";
            ...
            IEnumerable<Type> typelist
                ...
                && c.Namespace.StartsWith("ArgesDataCollectionWithWpf.DbModels.Models") 
                && c.IsClass
